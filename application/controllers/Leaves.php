  ...
  ;  }
    ...
    public function addNewRequest()
    {
          ...
          if($this->form_validation->run() == FALSE)
          {
            ...
            $data = array('type_id'=>$leavestype, 'duration'=>$duration, 'startdate'=>date('Y-m-d H:i:s', strtotime($startdate)), 'enddate'=> date('Y-m-d H:i:s',strtotime($enddate)),'status_id'=>$leavestatus,'comment'=>$comments);
            $this->load->model('Leaves_model');
    ...
    {
        $this->global['pageTitle'] = 'CodeInsect : List all leaves request';
    ...
    public function requests()
    {
      ...
      $data['listLeaves'] = $this->Leaves_model->ListallLeaveRequest();
      //var_dump(  $data['listLeaves']);exit();
       $this->loadViews('Leaves/request',$this->global , $data , null);
    }
}
